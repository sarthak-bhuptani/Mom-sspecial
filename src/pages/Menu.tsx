...
const Menu = () => {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className="pt-28 sm:pt-36 pb-8 sm:pb-12 bg-gradient-to-b from-primary/5 to-background text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto space-y-8">
            ...
            <motion.div
              ...
              className="bg-card rounded-3xl border border-border shadow-lg overflow-hidden flex flex-col h-[340px] sm:h-[400px] relative"
            >
              {/* Chat Header */}
              ...
              <div className="flex-1 bg-[#ECE5DD] dark:bg-neutral-900 p-4 sm:p-5 space-y-3 sm:space-y-4 overflow-y-auto flex flex-col">
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-neutral-800 text-foreground rounded-2xl rounded-tl-none p-3 sm:p-3.5 max-w-[88%] self-start shadow-sm border border-border/10 text-xs sm:text-sm leading-relaxed"
                >
                  👋 <strong>Good morning!</strong> Today&apos;s fresh home-style
                  tiffin is ready. Cooked with minimal oil and motherly care! ❤️
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-neutral-800 text-foreground rounded-2xl rounded-tl-none p-3 sm:p-4 max-w-[90%] self-start shadow-sm border border-border/10 relative"
                >
                  {/* Message Header */}
                  <div className="flex items-center gap-2.5 mb-3">
                    <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-base shrink-0">
                      🍱
                    </div>
                    <div>
                  ...
                  <div className="mt-3 pt-2 border-t border-border/10 flex items-center justify-between gap-3">
                    ...
                    <span className="text-[9px] sm:text-[10px] font-bold text-green-600 dark:text-green-400">
                      ✓ Freshly Prepared
                    </span>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="self-start flex items-center gap-1.5 bg-white/80 dark:bg-neutral-800 px-3 py-1.5 rounded-full shadow-sm"
                >
            ...
            <div className="text-center space-y-4">
              <Button
                variant="whatsapp"
                size="lg"
                className="w-full py-4 sm:py-6 px-4 sm:px-8 rounded-2xl shadow-md hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer font-bold flex items-center justify-center gap-2 sm:gap-3 text-sm sm:text-base whitespace-normal text-center h-auto"
                asChild
              >
                <a
                  href={whatsappUrl}
                ...
                >
                  ...
                  <span>
                    View Today&apos;s Menu on WhatsApp
                  </span>
                </a>
              </Button>
              <p className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider">
                ⚡ Get daily menu updates directly on WhatsApp
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 pt-4">
              ...
              <div className="bg-card p-5 rounded-2xl border border-border flex items-start gap-4 shadow-sm">
                ...
                <div>
                  <h4 className="font-extrabold text-sm text-foreground mb-1">
                    Why WhatsApp updates?
                  </h4>
                  <p className="text-xs text-muted-foreground leading-normal">
                    We buy fresh vegetables every morning and prepare food
                    based on what is fresh and best in the local market.
                    WhatsApp is the fastest way to see what&apos;s cooking today.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-card p-5 rounded-2xl border border-border flex items-start gap-4 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-normal">
                    Click the button above to view today&apos;s menu. Send us
                    a quick message to confirm your tiffin and share your
                    delivery sector.
                  </p>
                </div>
              </div>
